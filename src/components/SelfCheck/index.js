...
const SelfCheck = () => {
    ...
    return (
        <>
            <div>Symptoms may appear 2-14 days after exposure. <br/>
            This site does not collect any personal/medical data. </div>
            <br />
            <br />
            {!isSubmitted &&
                <form className="selfCheckButton" onSubmit={handleSubmit}>
                    ...
                    <label className="container">Do you have short on Breath?
                    <input
                            name="shortBreath"
                            type="checkbox"
                    ...
                    <label className="container">Do you have fever?
                    <input
                            name="fever"
                            type="checkbox"
                            checked={state.fever}
                    ...
                    <label className="container">Do you have muscle Pain?
                    <input
                            name="musclePain"
                            type="checkbox"
                    ...
                    <label className="container">Did you recently travel other countries?
                    <input
                            name="travel"
                            type="checkbox"
                    ...
                    <label className="container">Do you have tiredness
                    <input
                            name="tiredness"
                            type="checkbox"
                    ...
                    <label className="container">Do you have aches or Pains
                    <input
                            name="aches_or_pains"
                            type="checkbox"
                    ...
                    <label className="container">Do you have nasal congestion
                    <input
                    ...
                    <label className="container">Do you have runny nose
                    <input
                            name="runny_nose"
                            type="checkbox"
                    ...
                    <label className="container">Do you have sore throat
                    <input
                            name="sore_throat"
                            type="checkbox"
                    ...
                    <label className="container">Do you have diarrhea
                    <input
                            name="diarrhea"
                            type="checkbox"
            ...
            {isSubmitted && 
                ...
                <div className='serious'>
                    ...
                    You should immediately see doctor and set check up
                </div>
                <div className="ok">
